<template>
  <PageWrapper fixedHeight contentClass="flex bg-white">
    <Tabs tab-position="left" :tabBarStyle="tabBarStyle" @tabClick="componentClick" v-model:activeKey="activeKey" class="flex-1">
