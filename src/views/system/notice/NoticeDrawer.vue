...
<script lang="ts">
  ...
  import { saveInfo, updateInfo } from '/@/api/system/notice/notice';
...
export default defineComponent({
  ...
  setup(_, { emit }) {
      ...
      const getTitle = computed(() =>
        !unref(isUpdate) ? t('common.addText') + ' ' + t('views.components.notice') : t('common.updateText') + ' ' + t('views.components.notice'),
      );
