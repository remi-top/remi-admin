<template>
  <div ref="chatContainerRef" class="chat-container bg-white overflow-hidden" :style="chatContainerStyle">
...
<script setup lang="ts">
  ...
  const configUrl = {
    get: '/test-api/ai/chat/history/get',
    save: '/test-api/ai/chat/history/save',
  };
  ...
  watch(
    ...
    () => {
      chatContainerStyle.value = { height: `100%` };
    }
  );
  init();
</script>
