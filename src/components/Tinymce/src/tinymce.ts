...
export const toolbar = [
  'undo redo fontsizeselect lineheight searchreplace bold italic underline strikethrough alignleft aligncenter alignright outdent indent  blockquote code codesample hr bullist numlist link  preview anchor pagebreak image media fullscreen componentType',
];
