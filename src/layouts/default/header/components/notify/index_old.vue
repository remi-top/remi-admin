        ...
        <a-row class="bottom-buttons">
          ...
          <a-col :span="count === 0 ? 24 : 12">
            <a-button @click="popoverVisible = false" type="dashed" block>
              <router-link to="/sys/mynews">查看更多</router-link>
            </a-button>
          </a-col>
        </a-row>
      </template>
...
<script lang="ts">
  ...
  import DetailModal from '/@/views/sys/mynews/DetailModal.vue';
  import DynamicNotice from '/@/views/sys/mynews/DynamicNotice.vue';
  import { useModal } from '/@/components/Modal';
  import { useDesign } from '/@/hooks/web/useDesign';
  import { useGlobSetting } from '/@/hooks/setting';
  import { useUserStore } from '/@/store/modules/user';
  // import { connectWebSocket, onWebSocket, result } from '/@/hooks/web/useWebSocket';
  import { readAllMsg } from '/@/views/sys/mynews/mynews.api';
