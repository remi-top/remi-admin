<template>
  ...
  >
    ...
    <div :class="`${prefixCls}-menu-list`" ref="sideRef" :style="getMenuStyle">
      <LayoutTrigger :class="`${prefixCls}-trigger`" v-show="!getCollapsed" :style="getMenuStyle" style="left:0"/>
      <div
        v-show="!getCollapsed || openMenu"
        :class="[
      ...
      >
        <span class="text ml-2 font-bold"> {{ title }}</span>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const getMenuStyle = computed((): CSSProperties => {
        return {
          width: !unref(getCollapsed) ? `${unref(getMenuWidth)}px` : 0,
      ...
      const getDomStyle = computed((): CSSProperties => {
        const fixedWidth = !unref(getCollapsed) ? unref(getRealWidth) : 0;
...
<style lang="less">
  ...
  .@{prefix-cls} {
    ...
    > .scrollbar {
      height: calc(100% - @header-height-total);
    }
    ...
    &-menu-list {
      ...
      &__content {
        height: calc(100% - @header-height-total - 36px) !important;
